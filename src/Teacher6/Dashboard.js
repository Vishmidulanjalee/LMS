      ...
      <header className="bg-white shadow">
        <div className="max-w-8xl mx-0 px-4 sm:px-6 lg:px-8 py-3 flex justify-between items-center">
          <div>
            ...
            <h1 className="text-2xl font-medium text-gray-800">Grade 6</h1>
            <h2 className="text-lg font-normal text-gray-800 mt-1">{currentDate}</h2>
          </div>
          <div className="h-12 w-12 rounded-full bg-primary flex items-center justify-center text-white font-semibold text-md">
            {userInitials}
          </div>
        </div>
      </header>
        ...
        <div className="max-w-full mx-0 px-4 sm:px-6 lg:px-8 py-8">
          <div className="flex flex-col lg:flex-row gap-10 h-full">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:w-2/3">
              {[
                { title: "Add Notes", image: notes, description: "Add new notes for your lessons", route: "/Teacher6/Notes" },
                { title: "Add Homework", image: homework, description: "Create homework assignments", route: "/Teacher6/Homework" },
                { title: "Add Marks", image: marks, description: "Record student marks", route: "/Teacher6/Marks" },
...
export default TeacherDashboard6;
