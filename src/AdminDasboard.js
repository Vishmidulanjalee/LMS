              ...
              <div className="bg-white shadow-md rounded-xl p-5 min-h-[130px] flex flex-col md:flex-row justify-between items-center border">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 text-sm">Upload class recordings</p>
                  </div>
                </div>
                <button
              ...
              <div className="bg-white shadow-md rounded-xl p-5 min-h-[130px] flex flex-col md:flex-row justify-between items-center border">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 text-sm">Upload the exam result sheet</p>
                  </div>
                </div>
                <button
                  className="mt-4 md:mt-0 bg-yellow-500 text-white py-2 px-8 rounded hover:bg-yellow-600"
              ...
              <div className="bg-white shadow-md rounded-xl p-5 min-h-[130px] flex flex-col md:flex-row justify-between items-center border">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 text-sm">Upload tutes and papers </p>
                  </div>
                </div>
                <button
                  className="mt-4 md:mt-0 bg-yellow-500 text-white py-2 px-8 rounded hover:bg-yellow-600"
