      ...
      <header className="bg-white shadow">
        <div className="max-w-8xl mx-0 px-4 sm:px-6 lg:px-8 py-3 flex justify-between items-center">
          <div>
            ...
            <h1 className="text-2xl font-medium text-gray-800">Grade 10</h1>
        ...
        <div className="max-w-full mx-0 px-4 sm:px-6 lg:px-8 py-8">
          <div className="flex flex-col lg:flex-row gap-10 h-full">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:w-2/3">
              {[
                { title: "Add Notes", image: notes, description: "Add new notes for your lessons", route: "/Teacher10/Notes" },
                { title: "Add Homework", image: homework, description: "Create homework assignments", route: "/Teacher10/Homework" },
                { title: "Add Marks", image: marks, description: "Record student marks", route: "/Teacher10/Marks" },
