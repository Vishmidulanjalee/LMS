...
const VecWriteBrightNotes = () => (
  <svg width="54" height="54" viewBox="0 0 54 54" fill="none">
    ...
    {/* Bar chart lines on left page */}
    <rect x="15" y="30" width="4" height="7" rx="1" fill="#EC4899" opacity="0.6"/>
    <rect x="20" y="26" width="4" height="11" rx="1" fill="#EC4899" opacity="0.75"/>
    {/* Lines right page */}
...
const FOLDERS = [
  { key: 'Write to Bright - Essays',                    Vec: VecWriteBrightEssays, color: '#F97316', light: '#FFF7ED', border: '#FED7AA' },
  { key: 'Write to Bright - Notes, Notices & Graphs',   Vec: VecWriteBrightNotes,  color: '#EC4899', light: '#FDF2F8', border: '#FBCFE8' },
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
            ...
            <div>
              <h1 style={{ fontFamily: "'Playfair Display',serif", fontSize: 20, fontWeight: 700, color: '#111827', margin: 0, lineHeight: 1.2 }}>
                {openFolder ?? 'Recordings — June 2026'}
              </h1>
