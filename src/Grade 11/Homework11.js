...
const Homework11 = () => {
  ...
  useEffect(() => {
    const fetchHomeworkData = async () => {
      try {
        const querySnapshot = await getDocs(collection(db, "homework11")); // Updated collection for Grade 11
        ...
        const downloadUrlPromises = querySnapshot.docs.map(async (doc) => {
          ...
          return {
            id: doc.id,
            title,
            submissionLink: '/Grade11/Submission11', // Updated link for Grade 11
            pdfLink,
  ...
  return (
    <div className="flex">
      ...
      <div className="container mx-auto px-4 py-8">
        <h2 className="text-3xl font-bold mb-6">Homework - Grade 11</h2>
