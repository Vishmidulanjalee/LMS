          ...
          <div className="flex flex-col lg:flex-row gap-10 h-full">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:w-2/3">
              {[ // Updated for Grade 11
                { title: "Notes", image: notes, description: "Access important notes for your lessons", route: "/Grade11/Notes11" },
                { title: "Homework", image: homework, description: "Review and submit your homework", route: "/Grade11/Homework11" },
                { title: "Marks", image: marks, description: "View your latest marks and track progress", route: "/Grade11/Marks11" },
