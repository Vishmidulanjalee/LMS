        ...
        <div className="max-w-full mx-0 px-4 sm:px-6 lg:px-8 py-8">
          <div className="flex flex-col lg:flex-row gap-10 h-full">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:w-2/3">
              {[ // Updated for Grade 11
                { title: "Notes", icon: Book, description: "Access important notes for your lessons", route: "/Grade11/Notes11" },
                { title: "Homework", icon: FileText, description: "Review and submit your homework", route: "/Grade11/Homework11" },
                { title: "Marks", icon: GraduationCap, description: "View your latest marks and track progress", route: "/Grade11/Marks11" },
                { title: "Other", icon: FileText, description: "Explore additional resources for Grade 11" },
              ].map((item, index) => (
