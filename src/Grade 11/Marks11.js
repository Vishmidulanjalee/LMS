...
const StudentMarks11 = () => {
  ...
  useEffect(() => {
    const fetchMarksData = async () => {
      try {
        const marksList = [];
        const querySnapshot = await getDocs(collection(db, "marks11")); // Updated collection name for Grade 11
  ...
  return (
    <div className="flex">
      <div className="container mx-auto px-4 py-8">
        <h2 className="text-3xl font-bold mb-6">Marks - Grade 11</h2>
