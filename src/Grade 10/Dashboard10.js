          ...
          <div className="flex flex-col lg:flex-row gap-10 h-full">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:w-2/3">
              {[ // Updated for Grade 10
                { title: "Notes", image: notes, description: "Access important notes for your lessons", route: "/Grade10/Notes10" },
                { title: "Homework", image: homework, description: "Review and submit your homework", route: "/Grade10/Homework10" },
                { title: "Marks", image: marks, description: "View your latest marks and track progress", route: "/Grade10/Marks10" },
