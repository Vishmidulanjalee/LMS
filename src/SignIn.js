  ...
  <div className="flex min-h-screen items-center justify-center bg-yellow-100 px-4">
    <motion.div className="w-full max-w-md bg-white p-6 rounded-lg shadow-lg"
      ...
      <form className="mt-1 space-y-6" onSubmit={handleSignIn}>
        ...
        <button type="submit" className="w-full bg-yellow-500 hover:bg-yellow-600 text-white py-2 px-4 rounded-md">Sign In</button>
      </form>
      {resetMessage && <p className="mt-4 text-center text-sm text-green-500">{resetMessage}</p>}
        ...
        <div className="flex min-h-screen flex-col bg-gradient-to-br from-white to-yellow-200 md:flex-row">
          ...
          <motion.div className="w-full md:w-1/2 bg-white p-6 md:p-12 flex flex-col justify-center"
            initial={{ opacity: 0, x: 50 }}
            animate={{ opacity: 1, x: 0 }}
            ...
            <form className="space-y-6 ml-10" onSubmit={handleSignIn}>
              ...
              <div className="w-4/5">
                <button type="submit" className="w-full bg-yellow-500 hover:bg-yellow-600 text-white py-2 px-4 rounded-md">
                  Sign In
                </button>
              </div>
            </form>
