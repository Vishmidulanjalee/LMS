...
const Homework9 = () => {
  ...
  useEffect(() => {
    const fetchHomeworkData = async () => {
      try {
        const querySnapshot = await getDocs(collection(db, "homework9"));
        ...
        const downloadUrlPromises = querySnapshot.docs.map(async (doc) => {
          ...
          return {
            id: doc.id,
            title,
            submissionLink: '/Grade9/Submission9', // Updated link
            pdfLink,
  ...
  return (
    <div className="flex">
      ...
      <div className="container mx-auto px-4 py-8">
        <h2 className="text-3xl font-bold mb-6">Homework - Grade 9</h2>
